 ...
 */
(function(){
  var lib, test, ed25519_public, ed25519_private, expected_x25519_public, expected_x25519_private;
  lib = require('..');
  test = require('tape');
  ...
  lib.ready(function(){
    test('Keypair conversion', function(t){
      var x25519_public, x25519_private;
      t.plan(2);
